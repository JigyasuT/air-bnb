...
const ViewCard = () => {
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto relative">
      ...
      {/* Update Listinge Page  */}
      {updatePopUp && (
        <div className="w-[100%] h-[100%] flex items-center justify-center bg-[#000000c6] absolute top-[0px] z-[100] backdrop-blur-sm">
          <RxCross2
            className="w-[30px] h-[30px] bg-[white]  cursor-pointer absolute top-[6%] left-[25px] rounded-[50%] flex items-center justify-center"
          ...
          >
            ...
            <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] text-[black]">
              ...
              <input
                ...
                type="text"
                id="title"
                placeholder="__BHK house or best title"
                required
            ...
            <div className="w-[100%] flex items-center justify-center gap-[30px] mt-[20px]">
              ...
              <button
                className="px-[10px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg md:text-[18px] text-nowrap"
      ...
      {bookingPopUp && (
        <div className="w-[100%] min-h-[100%] flex items-center justify-center flex-col gap-[30px]  bg-[white] absolute top-[0px] z-[100] p-[20px]  backdrop-blur-sm md:flex-row md:gap-[100px]">
          ...
          <form className="max-w-[450px] w-[90%] h-[450px] overflow-auto bg-[#f7fbfcfe]  p-[20px] rounded-lg flex items-center justify-center flex-col gap-[10px] border-[1px] border-[#dedddd]">
            <h1 className="w-[100%] flex items-center py-[10px] text-[25px] border-b-[1px] border-[#a3a3a3]">
              Confirm & Book
            </h1>
            <div className="w-[100%] h-[70%] mt-[10px] rounded-lg p-[10px] ">
              <h3 className="text-[19px] font-semibold">Your Trips -</h3>
              <div className="w-[90%] flex items-center justify-start flex-col gap-[24px] mt-[20px] md:justify-center flex-col md:flex-row md:items-start">
              ...
              <div className="w-[90%] flex items-center justify-start flex-col gap-[10px] mt-[40px] md:justify-center flex-col md:flex-row md:items-start">
                <label
                  htmlFor="checkOut"
              ...
              <div className="w-[100%] flex items-center justify-center">
                <button className="px-[80px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg  text-nowrap mt-[15px]"
                type="button"
          ...
          <div className="max-w-[450px] w-[90%] h-[450px] bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-center flex-col gap-[10px] border-[1px] border-[#e2e1e1]">
            <div className="w-[95%] h-[30%] border-[1px] border-[#9b9a9a] rounded-lg flex justify-center items-center gap-[8px] p-[20px] overflow-hidden">
              ...
              <div className="w-[80%] h-[100px] gap-[5px]">
                ...
                <h1 className="w-[90%] truncate">{`IN ${cardDetails.title.toUpperCase()}`}</h1>
                <h1 className="w-[90%] truncate">{`IN ${cardDetails.category.toUpperCase()}`}</h1>
                <h1 className="flex items-center justify-start gap-[5px] ">
                  {" "}
                  <IoStarSharp className="text-[#eb6262]"  />
                  {cardDetails.ratings}{" "}
                </h1>
              </div>
            </div>
