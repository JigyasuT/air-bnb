...
const Nav = () => {
  ...
  try {
    const result = await axios.post(
      ...
      {}, // 👈 empty body
      {
        withCredentials: true, // ✅ yahan aayega
      }
    );
    ...
    toast.error("Users Doesn't Logout...")
    console.log(error);
  }
};
    ...
    <div className="fixed top-0 bg-[white] z-[20]">
      <div className="w-[100vw] min-h-[80px]  border-b-[1px] border-[#dcdcdc] px-[40px] flex items-center justify-between md:px-[40px] ">
        ...
        <div className="w-[35%] relative hidden md:block">
          <input
            type="text"
            className="w-[100%] px-[30px] outline-none py-[10px] border-[2px] border-[#bdbaba] outline-none overflow-auto rounded-[30px] text-[17px] "
      ...
      <div>
        <div className="w-[100vw] h-[85px] bg-white flex items-center justify-start cursor-pointer gap-[40px] overflow-auto  md:justify-center px-[15px]">
          ...
          <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[13px] ${cate=='villa'?"border-b-[1px] border-[#a6a5a5]":""} `} onClick={()=>handleCategory("villa")}>
            <GiVillage className="w-[30px] h-[30px] text-black" />
            <h3>Villa</h3>
          </div>
